...
describe('BIP39 Mnemonic Test Vectors', () => {
  const testVectors = [
    {
  ...
  describe('Mnemonic generation from entropy', () => {
    testVectors.forEach((vector, index) => {
      it(`should generate correct mnemonic for test vector ${index + 1}`, () => {
  ...
  describe('Seed generation from mnemonic', () => {
    testVectors.forEach((vector, index) => {
      it(`should generate correct seed for test vector ${index + 1}`, () => {
        const seed = bip39.mnemonicToSeedSync(vector.mnemonic, vector.passphrase);
  ...
  describe('Mnemonic validation', () => {
    testVectors.forEach((vector, index) => {
      it(`should validate mnemonic for test vector ${index + 1}`, () => {
    ...
    it('should reject mnemonic with invalid checksum', () => {
      expect(bip39.validateMnemonic('abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon')).toBe(false);
    });
  });

  describe('Entropy to mnemonic and back', () => {
    testVectors.forEach((vector, index) => {
      it(`should convert entropy to mnemonic and back for test vector ${index + 1}`, () => {
        const mnemonic = bip39.entropyToMnemonic(vector.entropy);
