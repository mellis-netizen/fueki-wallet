...
enum AppConfig {
    static let label = "io.fueki.wallet"
    static let backupSalt = "fueki"

    static let companyName = "Fueki Technologies"
    static let reportEmail = "support@fueki.io"
    static let companyWebPageLink = "https://fueki.io"
    static let appWebPageLink = "https://fueki.money"
    static let analyticsLink = "https://fueki.money/analytics"
    static let privacyPolicyLink = "https://fueki.money/privacy"
    ...
    static let appGitHubAccount = "fueki"
    static let appGitHubRepository = "fueki-wallet-ios"
    static let appTwitterAccount = "fuekiwallet"
    static let appTelegramAccount = "fueki_announcements"
    static let appTokenTelegramAccount = "FuekiWallet_bot"
    static let mempoolSpaceUrl = "https://mempool.space"
    static let guidesIndexUrl = URL(string: "https://raw.githubusercontent.com/fueki/blockchain-crypto-guides/v1.2/index.json")!
    static let faqIndexUrl = URL(string: "https://raw.githubusercontent.com/fueki/fueki-wallet-website/master/src/faq.json")!
    static let eduIndexUrl = URL(string: "https://raw.githubusercontent.com/fueki/fueki-wallet-website/refs/tags/v1.4/src/edu.json")!
